...
{
    return QString("Stellarium for Sailfish")+" "+StelUtils::getApplicationVersion();
}
...
{
    return (double)(dateTime.date().toJulianDay())+(double)1./(24.*60.*60.*1000.)*(double)QTime(0, 0).msecsTo(dateTime.time())-0.5;
}
