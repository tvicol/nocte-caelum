...
public slots:
    ...
    //! Set Free Look (device orentation based movement)
    void setFreeLook(bool b) { freeLook = b; }
    bool getFreeLook() const { return freeLook; }

    void setFreeLookMatrix(const Mat4d& m) { matDeviceModelView = m; }
