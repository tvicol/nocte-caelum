...
#ifndef _STELSEARCH_HPP_
#define _STELSEARCH_HPP_
...
class StelSearch : public QObject
{
    Q_OBJECT

public:
    explicit StelSearch(QObject* parent = 0);

public slots:
    void updateSearchResults(const QString& text, QStringList& matches);
    bool gotoObject(const QString& name);
    bool gotoNamedObject(const QString& text, bool recheck);
